        ...
        <div class="col-md-12">
          <div class="book_select">
            <el-tabs @tab-click="tabClickBookInfo" :tab-position="tabPosition">
              ...
              <el-tab-pane label="课程目录" name="bookContents">
              ...
              <el-tab-pane label="课程讨论" name="bookComment">
                <div class="book_info_right">
                  <el-tabs v-model="activeComment" @tab-click="comentClick">
                    <el-tab-pane label="热点" name="hotComment">
                      <div class="book_comment">
                        <div v-for="item in commentList" class="event">
                          <div class="comment_label">
                            <a href="https://learnku.com/users/49196">
                              <img
                                src="https://cdn.learnku.com/uploads/avatars/49196_1568765806.jpeg!/both/100x100"
                              />
                            </a>
                          </div>
                          <div class="comment_content">
                            ...
                            <div class="summary">
                              <a
                                href="https://learnku.com/laravel/t/55351"
                                class="title"
                              >
                                {{ item.title }}
                              </a>
                    ...
                    <el-tab-pane label="精华" name="bestComment">
                      <div class="book_comment">
                        <div v-for="item in commentList" class="event">
                          <div class="comment_label">
                            <a href="https://learnku.com/users/49196">
                    ...
                    <el-tab-pane label="最近" name="latestComment">
                      <div class="book_comment">
                        <div v-for="item in commentList" class="event">
                          <div class="comment_label">
                            <a href="https://learnku.com/users/49196">
                    ...
                    <el-tab-pane label="未解决" name="undealComment">
                      <div class="book_comment">
                        <div v-for="item in commentList" class="event">
                          <div class="comment_label">
                            <a href="https://learnku.com/users/49196">
