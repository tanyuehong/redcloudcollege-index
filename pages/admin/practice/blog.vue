      ...
      <div class="setting-content">
        ...
        <div class="right-content">
          <div class="person-setting shadow" v-if="settingtype === 1">
            <div class="nav-text">博文列表</div>
            <div class="admin-content">
              <el-table :data="questionList" height="560">
                <el-table-column property="title" label="题目" width="420"></el-table-column>
  ...
  methods: {
    ...
    everyDayQuestionClick() {
      ...
      if (this.slectDate.length == 0) {
        ...
        // 组合年份、月份和日期，以生成 "2010-06-23" 格式日期
        this.slectDate = date.getFullYear() + '-' + month + '-' + day;
      }
      interviewAdmin
        .getEveryDayQuestionList(this.slectDate)
        .then(response => {
