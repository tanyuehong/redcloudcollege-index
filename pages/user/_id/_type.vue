		...
		<div class="container">
			<div class="col-md-8">
				<div class="ucenter-home-content">
					<el-tabs v-model="parmType" @tab-click="userTypeClick" :tab-position="tabPosition">
						<el-tab-pane label="文章" name="blog">
							<div class="user_article_content book_item">
								<div class="nodata-warper" v-if="articleList.length == 0">
									<img class="nodata-image-tips" src="https://img.redskt.com/asset/img/nodata.png" />
									<div>
										<span>该用户暂时还没有文章哦</span>
									</div>
								</div>
						...
						<el-tab-pane label="关注" name="focus">关注</el-tab-pane>
					</el-tabs>
				</div>
			</div>
				...
				<div class="info-honor">
					...
					<div class="block-body">
						...
						<div class="stat-item"><svg width="25" height="25" viewBox="0 0 25 25" class="icon stat-view-icon">
							...
							</svg> <span class="content">文章被阅读<span class="count">{{ userInfo.viewsum }}</span></span></div><a
							href="https://juejin.cn/book/6844733795329900551/section/6844733795371843597" target="_blank"
							rel="nofollow noopener noreferrer" class="stat-item" data-v-4fa4e5da=""><svg
							...
							</svg> <span class="content">源力值<span class="count">{{ userInfo.practice }}</span></span></a>
						<!---->
					</div>
				</div>
				<!---->
...
export default {
	...
	mounted () {
		userServerApi.getShowUserInfo(this.parmUid).then(response => {
		});
